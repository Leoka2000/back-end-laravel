...
const Home = () => {
    ...
    const handleChange = e => {
        ...
        const filtered = scholarships.filter(
            (scholarship) =>
              scholarship.name.toLowerCase().includes(e.target.value.toLowerCase()) ||
              scholarship.type.toLowerCase().includes(e.target.value.toLowerCase())
          );
            ...
            <main className='home-main'>
                ...
                <div className='right'>
                    ...
                    <Suspense fallback={<BeatLoader />}>
                        {loading ? (
                            <BeatLoader className='loader' size={40} color='grey' />
